                    ...
                    <Card hoverable className="news-card">
                        <a href={news.url} target="_blank" rel="noreferrer">
                            <div className="news-image-container">
                                ...
                                <img style={{maxWidth:'200px',maxHeight:'100px'}} src={news?.image?.thumbnail?.contentUrl || demoImage} alt="news-image" className="news-image-thumb"/>
                            </div>
                            <p>
                            ...
                            <div className="provider-container">
                                <div>
                                    <Avatar style={{minWidth:'35px',minHeight:'35px'}}  src={news.provider[0]?.image?.thumbnail?.contentUrl || demoImage} />
